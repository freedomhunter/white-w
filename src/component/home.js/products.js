                        ...
                        <div className="products_container grid">
                            ...
                            <div className="product grid-item hot">
                                <div className="product_inner">
                                    ...
                                    <div className="product_content text-center">
                                        <div className="product_title"><a href="product.html">long red shirt</a></div>
                                        <div className="product_price">$39.90</div>
                                        <div className="product_button ml-auto mr-auto trans_200"><a href="#">add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="product grid-item">
                                <div className="product_inner">
                                    ...
                                    <div className="product_content text-center">
                                        <div className="product_title"><a href="product.html">hype grey shirt</a></div>
                            ...
                            <div className="product grid-item sale">
                                <div className="product_inner">
                                    ...
                                    <div className="product_content text-center">
                                        <div className="product_title"><a href="product.html">long sleeve jacket</a></div>
                                        <div className="product_price">$32.20<span>RRP 64.40</span></div>
                                        <div className="product_button ml-auto mr-auto trans_200"><a href="#">add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="product grid-item">
                                <div className="product_inner">
                                    ...
                                    <div className="product_content text-center">
                                        <div className="product_title"><a href="product.html">denim men shirt</a></div>
                            ...
                            <div className="product grid-item sale">
                                <div className="product_inner">
                                    ...
                                    <div className="product_content text-center">
                                        <div className="product_title"><a href="product.html">denim men shirt</a></div>
                                        <div className="product_price">$43.99<span>RRP 64.40</span></div>
                                        <div className="product_button ml-auto mr-auto trans_200"><a href="#">add to cart</a></div>
                                    </div>
                                </div>
                            </div>
