					...
					<div className="row">
						<div className="col">
							<div className="footer_social_container d-flex flex-row align-items-center justify-content-between">
								...
								<a href="#">
									<div className="footer_social_item d-flex flex-row align-items-center justify-content-start">
										<div className="footer_social_icon"><i className="fa fa-google-plus" aria-hidden="true"></i></div>
								...
								<a href="#">
									<div className="footer_social_item d-flex flex-row align-items-center justify-content-start">
										<div className="footer_social_icon"><i className="fa fa-pinterest" aria-hidden="true"></i></div>
								...
								<a href="#">
									<div className="footer_social_item d-flex flex-row align-items-center justify-content-start">
										<div className="footer_social_icon"><i className="fa fa-twitter" aria-hidden="true"></i></div>
								...
								<a href="#">
									<div className="footer_social_item d-flex flex-row align-items-center justify-content-start">
										<div className="footer_social_icon"><i className="fa fa-youtube" aria-hidden="true"></i></div>
								...
								<a href="#">
									<div className="footer_social_item d-flex flex-row align-items-center justify-content-start">
										<div className="footer_social_icon"><i className="fa fa-tumblr-square" aria-hidden="true"></i></div>
